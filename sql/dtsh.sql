...
INSERT INTO `task` VALUES (2, '垃圾分类知识问答', '在规定的时间内完成垃圾分类知识问答题', 0.00, 999,'/server/image/task/img.png');
INSERT INTO `task` VALUES (3, '“绿意盎然”家庭节能挑战赛', '“绿意盎然”家庭节能挑战赛是一项为期一个月的家庭低碳生活实践活动。参与的家庭将在挑战期间尽可能减少能源消耗，如电力、天然气等，同时记录并分享他们的节能方法和成果。活动结束后，将根据节能效果评选出优胜家庭，并颁发奖品以资鼓励。此活动旨在提高家庭成员的节能意识，并帮助他们养成低碳生活的好习惯。', 0.00, 999,'/server/image/task/img.png');
INSERT INTO `task` VALUES (4, '绿色出行周', '“绿色出行周”活动鼓励市民在一周内采用低碳出行方式，如步行、骑行、乘坐公共交通等，减少私家车使用。活动期间，将设立多个绿色出行站点，提供自行车租赁、公交卡充值等便利服务，并举办相关宣传活动，如环保讲座、绿色出行摄影展等。此活动旨在提高市民对绿色出行的认识，并推动形成低碳出行的社会风尚。', 0.00, 999,'/server/image/task/img.png');
INSERT INTO `task` VALUES (5, '环保创意市集', '“环保创意市集”是一个集环保理念、创意设计和手工艺术于一体的活动。市集上，将展示和销售各种低碳环保的生活用品、艺术品和创意作品，如手工肥皂、再生纸制品、旧物改造的家居饰品等。同时，还将邀请环保专家和手工艺人进行现场教学，传授环保知识和手工制作技巧。此活动旨在推广环保理念，激发公众的创意和环保意识。', 0.00, 999,'/server/image/task/img.png');
INSERT INTO `task` VALUES (6, '“零废弃”生活体验营', '“零废弃”生活体验营是一个为期几天的低碳生活体验活动。参与者将在活动期间学习并实践零废弃的生活方式，如垃圾分类、厨余堆肥、自制环保清洁剂等。活动还将组织参观零废弃社区和企业，了解他们的实践经验和成果。此活动旨在让参与者深入了解零废弃生活的可行性和好处，并鼓励他们将所学应用到日常生活中。', 0.00, 999,'/server/image/task/img.png');
INSERT INTO `task` VALUES (7, '低碳校园行', '“低碳校园行”是一个面向学校学生的低碳生活宣传活动。活动将通过举办讲座、展览、互动游戏等形式，向学生介绍低碳生活的重要性和实践方法。同时，还将鼓励学生参与校园节能、节水、节电等实践活动，培养他们的环保意识和社会责任感。此活动旨在让学生在校园中体验和实践低碳生活，为未来的环保事业培养更多的人才。', 0.00, 999,'/server/image/task/img.png');
